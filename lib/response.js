...
class NodeResponse {
    constructor(app, done) {
         ...
         * @public
         */
        this.status = function status(code) {
       ...
       *    });
        ...
        this.send = function send(body) {
            ...
            let etagFn = app.getOption('etag fn');
        ...
        this.json = function json(obj) {
            ...
            // settings
            let app = this.app;
            let escape = app.getOption('json escape');
            let replacer = app.getOption('json replacer');
            let spaces = app.getOption('json spaces');
        ...
        this.jsonp = function jsonp(obj) {
            ...
            let spaces = app.getOption('json spaces');
            let body = stringify(val, replacer, spaces, escape);
            let callback = this.req.query[app.getOption('jsonp callback name')];
            // content-type
            if (!this.get('Content-Type')) {
         ...
         * @public
         */
        this.sendStatus = function sendStatus(statusCode) {
       ...
       *     });
         ...
         * @public
         */
        this.sendFile = function sendFile(path, options, callback) {
            let done = callback;
            let req = this.req;
            let res = this;
            let next = req.next;
       ...
       *     });
         ...
         * @public
         */
        this.download = function download(path, filename, options, callback) {
            let done = callback;
            let name = filename;
       ...
       *    });
         ...
         * @public
         */
        this.attachment = function attachment(filename) {
            if (filename) {
         ...
         * @public
         */
        this.append = function append(field, val) {
         ...
         * @public
         */
        this.clearCookie = function clearCookie(name, options) {
         ...
         * @public
         */
        this.location = function location(url) {
            let loc = url;
         ...
         * @public
         */
        this.render = function render(view, options, callback) {
    ...
    header(field, val) {
        ...
        this.done(new Response(chunk, responseOptions));
    }
}
