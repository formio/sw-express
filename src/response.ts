...
function sendfile(res, file, options, callback) {
  ...
  function onaborted() {
    ...
    let err: any = new Error('Request aborted');
  ...
  function ondirectory() {
    ...
    let err: any = new Error('EISDIR, read');
    err.code = 'EISDIR';
    callback(err);
  }
 ...
 *     });
  ...
  download = function download(path, filename, options, callback) {
    let done = callback;
    let name = filename;
 ...
 *    });
  ...
  location = function location(url) {
    let loc = url;
